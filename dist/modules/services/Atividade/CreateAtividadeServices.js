...
class CreateClientesService {
    execute({ uuidatividade, atividade, cod_atv }) {
        return __awaiter(this, void 0, void 0, function* () {
            const clientesRepository = (0, typeorm_1.getCustomRepository)(AtividadeRepository_1.default);
            const checkUserExists = yield clientesRepository.findById(uuidatividade);
            if (checkUserExists) {
