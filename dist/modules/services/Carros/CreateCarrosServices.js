...
class CreateCargoService {
    execute({ id_uuid, placa, carro, ano, cor, km, ativo, garagem, id }) {
        return __awaiter(this, void 0, void 0, function* () {
            const carrosRepository = (0, typeorm_1.getCustomRepository)(CarrosRepository_1.default);
            const checkUserExists = yield carrosRepository.findById(id_uuid);
            if (checkUserExists) {
            ...
            yield carrosRepository.save(carros);
            return carros;
        });
    }
}
