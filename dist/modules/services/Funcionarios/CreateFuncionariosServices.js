...
class CreateClientesService {
    execute({ cod_func_uuid, cod_cargo, cod_usuario, cod_func }) {
        return __awaiter(this, void 0, void 0, function* () {
            const clientesRepository = (0, typeorm_1.getCustomRepository)(FuncionarioRepository_1.default);
            const checkUserExists = yield clientesRepository.findById(cod_func_uuid);
            if (checkUserExists) {
