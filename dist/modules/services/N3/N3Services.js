...
const N3Repository_1 = __importDefault(require("../../typeorm/repositories/N3Repository"));
class CreateServices {
    create({ uuidn3, codigo, descricao }) {
        return __awaiter(this, void 0, void 0, function* () {
            const repository = (0, typeorm_1.getCustomRepository)(N3Repository_1.default);
    ...
    update({ uuidn3, codigo, descricao }) {
        return __awaiter(this, void 0, void 0, function* () {
            const repository = (0, typeorm_1.getCustomRepository)(N3Repository_1.default);
            const result = yield repository.findOne(uuidn3);
            if (!result) {
