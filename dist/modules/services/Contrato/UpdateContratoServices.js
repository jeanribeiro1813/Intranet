...
class UpdateClientService {
    update({ uuidcontrato, contrato }) {
        return __awaiter(this, void 0, void 0, function* () {
            const usersRepository = (0, typeorm_1.getCustomRepository)(ContratoRepository_1.default);
            const client = yield usersRepository.findOne(uuidcontrato);
            if (!client) {
