...
class CreateManuntencoesService {
    execute({ cod_manutencao_uuid, descricao, valor, cod_manutencao }) {
        return __awaiter(this, void 0, void 0, function* () {
            const clientesRepository = (0, typeorm_1.getCustomRepository)(ManuntencoesRepository_1.default);
            const checkUserExists = yield clientesRepository.findById(cod_manutencao_uuid);
            if (checkUserExists) {
...
exports.default = CreateManuntencoesService;
