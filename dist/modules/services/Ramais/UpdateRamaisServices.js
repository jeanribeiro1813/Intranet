...
class UpdateRamaiservice {
    update({ uuidramal, ramal, cod_atv }) {
        return __awaiter(this, void 0, void 0, function* () {
            const usersRepository = (0, typeorm_1.getCustomRepository)(RamaisRepository_1.default);
            const client = yield usersRepository.findOne(uuidramal);
            if (!client) {
...
exports.default = UpdateRamaiservice;
