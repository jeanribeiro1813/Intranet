...
class CreatePagamentoService {
    execute({ uuidpagamento, empresa, uuidprojeto, n1, n2, n3, uuidcolab_forne, valor_pago, data_pagto, data_vecto, uuidbancos, incidencia, parcelas_n, n_doc_pagto, uuidformapagto, status, obs }) {
        return __awaiter(this, void 0, void 0, function* () {
            const clientesRepository = (0, typeorm_1.getCustomRepository)(PagamentoRepository_1.default);
            const checkUserExists = yield clientesRepository.findByCode(uuidpagamento);
            if (checkUserExists) {
...
exports.default = CreatePagamentoService;
