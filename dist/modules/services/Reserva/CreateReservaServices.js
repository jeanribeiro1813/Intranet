...
class CreateReservaService {
    execute({ cod_reserva_uuid, placa, usuario, dt_saida, dt_chegada, hora_saida, hora_chegada, km_saida, km_chegada, projeto, cancelado, desc_cancel, dev_obs, cod_reserva }) {
        return __awaiter(this, void 0, void 0, function* () {
            const clientesRepository = (0, typeorm_1.getCustomRepository)(ReservaRepository_1.default);
            const checkUserExists = yield clientesRepository.findById(cod_reserva_uuid);
            if (checkUserExists) {
...
exports.default = CreateReservaService;
