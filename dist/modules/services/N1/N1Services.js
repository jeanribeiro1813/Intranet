...
const N1Repository_1 = __importDefault(require("../../typeorm/repositories/N1Repository"));
class CreateServices {
    create({ uuidn1, codigo, descricao }) {
        return __awaiter(this, void 0, void 0, function* () {
            const repository = (0, typeorm_1.getCustomRepository)(N1Repository_1.default);
            const checkUserExists = yield repository.findById(uuidn1);
            if (checkUserExists) {
    ...
    update({ uuidn1, codigo, descricao }) {
        return __awaiter(this, void 0, void 0, function* () {
            const repository = (0, typeorm_1.getCustomRepository)(N1Repository_1.default);
            const result = yield repository.findOne(uuidn1);
            if (!result) {
