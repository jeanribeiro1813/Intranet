...
const BancosRepository_1 = __importDefault(require("../../typeorm/repositories/BancosRepository"));
class CreateServices {
    create({ uuidbanco, codigo, descricao }) {
        return __awaiter(this, void 0, void 0, function* () {
            const repository = (0, typeorm_1.getCustomRepository)(BancosRepository_1.default);
            const checkUserExists = yield repository.findById(uuidbanco);
            if (checkUserExists) {
    ...
    update({ uuidbanco, codigo, descricao }) {
        return __awaiter(this, void 0, void 0, function* () {
            const repository = (0, typeorm_1.getCustomRepository)(BancosRepository_1.default);
            const result = yield repository.findOne(uuidbanco);
            if (!result) {
